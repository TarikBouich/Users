          ...
          <table class="w-full" v-if="users.length > 0">
            ...
            <tbody>
              <tr v-for="(user, key) in users" :key="key">
                ...
                <td class="p-4 text-left text-sm">
                  <button @click="deleteUser(key)" class="block w-10 h-10 mx-auto">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 108.294 122.88" xml:space="preserve" class="w-3 h-7">
                        <g>
